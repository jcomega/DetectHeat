...
#define UART_CLOCK_FREQ      GetSystemClock()

#define UARTINTC_TXON
#define UARTINTC_RXON
#define UARTINTC_BAUDRATE 9600
#define UARTINTC_TX_BUFFER_SIZE 50
#define UARTINTC_RX_BUFFER_SIZE 15
#endif
...
//--------------------------------------------------------------------------------------------------------------------------------------------
/*! \fn  int UART1_put_string(char *s)
 *  \brief send charactere string
 *
 *  \return void
 */
//--------------------------------------------------------------------------------------------------------------------------------------------
int UART1_put_stringROM(rom const char *str);
int UART1_put_stringRAM(char *str);
